...
def analyse_step2(files, repo_name):
    ...
    prompt = (
        ...
        "AUTH_ANALOGY: a vivid specific real-world analogy tied to what THIS app does — make it memorable and specific to the app type (booking, ecommerce, document management etc)\n"
