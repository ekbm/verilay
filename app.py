...
def analyse_step3(files, repo_name):
    ...
    prompt = (
        ...
        "- CRITICAL: verify_jwt=false in supabase/config.toml is the Lovable Cloud DEFAULT — it does NOT mean functions are unprotected. Each function validates auth in-code. NEVER flag verify_jwt=false as a security issue for Lovable apps\n"
