...
def run_step4():
    ...
    try:
        ...
        print(f"Part 2 update: report_id={report_id}, has_supabase={_HAS_SUPABASE}")
        ...
        if report_id:
            if _HAS_SUPABASE:
                try:
                    ...
                    print(f"Existing report found: {existing is not None}")
                    if existing:
                        existing.update({
                        ...
                        update_result = _sb.table("reports").update({"data": existing}).eq("id", report_id).execute()
                        print(f"Supabase update result: {update_result.data}")
                    else:
                        print(f"No existing report found for id: {report_id}")
                except Exception as e:
                    print(f"Supabase Part 2 update failed: {e}")
            else:
                print("Supabase not available — skipping update")
